...
model = se_resnet.se_resnet34(NUM_CLASSES, GRAYSCALE)
...
if __name__ == '__main__':
    ...
    for epoch in range(num_epochs):
        ...
        if valid_mae < best_mae:
            ...
            ########## SAVE MODEL #############
            torch.save(model.state_dict(), os.path.join(PATH, '0518best_model.pt'))
    ...
    ########## EVALUATE BEST MODEL ######
    model.load_state_dict(torch.load(os.path.join(PATH, '0518_seresnet34_best_model.pt')))
    model.eval()
