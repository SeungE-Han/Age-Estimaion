...
def se_resnet34(num_classes, grayscale):
    ...
    model.avgpool = nn.AdaptiveAvgPool2d(1)"""
    model = ResNet(block=SEBasicBlock,
                   layers=[3, 4, 6, 3],
...
def se_resnet50(num_classes, grayscale, pretrained=False):
    ...
    model = ResNet(block=SEBottleneck,
                   layers=[3, 4, 6, 3],
                   num_classes=num_classes,
                   grayscale=grayscale)
    return model
